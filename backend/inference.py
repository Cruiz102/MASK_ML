from third_party.sam2.sam2.sam2_video_predictor import SAM2VideoPredictorVOS
import torch
import contextlib
...
class InferenceAPI:
    def __init__(self):
        self.predictor = SAM2VideoPredictorVOS()
        self.predictor.from_pretrained("facebook/sam2-hiera-large")
        self.session_states: Dict[str, Any] = {}
        self.score_thresh = 0
        self.checkpoint = Path( "checkpoints/sam2.1_hiera_tiny.pt")
